...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        # my arg
        self.parser.add_argument("--train_split", type=str, default="train_small.txt")
        self.parser.add_argument("--val_split", type=str, default="val_small.txt")
        # self.parser.add_argument("--dist_port", type=int, default=12584)
        self.is_train = True
