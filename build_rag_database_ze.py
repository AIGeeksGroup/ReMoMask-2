...
def encode_ze_batch(vq_model, x2d_batch, device):
    """Encode a batch of x2d tensors to z_e vectors.
    ...
    Returns:
        z_e: (B, code_dim2d) numpy, L2-normalised
    """
...
def main():
    ...
    def flush_batch():
        ...
        z_e = encode_ze_batch(vq_model, x2d_arr, device)  # (B, code_dim2d)
    ...
    print(f"  metadata.json: code_dim2d={code_dim2d}")
