...
if __name__ == '__main__':
    ...
    net = RVQVAE(opt, dim_pose, opt.down_t, opt.stride_t, opt.width, opt.depth, opt.dilation_growth_rate, opt.vq_act, opt.vq_norm)
    pc_vq = sum((param.numel() for param in net.parameters()))
    print('Total parameters of all models: {}M'.format(pc_vq / 1000000))
