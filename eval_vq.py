...
if __name__ == '__main__':
    ...
    vq_opt.name = args.name
    file = args.which_epoch
    print(file)
    ...
    for i in range(repeat_time):
        (best_fid, best_div, Rprecision, best_matching, l1_dist) = eval_t2m.evaluation_vqvae_plus_mpjpe(eval_val_loader, net, i, eval_wrapper=eval_wrapper, num_joint=args.nb_joints)
        fid.append(best_fid)
        div.append(best_div)
